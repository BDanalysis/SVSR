...
do
echo "iterator ${j}"
./illumina -infile_norm $my_infile_ref -infile_tumor $my_infile_ref -infile_pf1 $my_infile_pf1 -infile_pf2 $my_infile_pf2 -infile_pe_se $my_infile_pe_se -infile_gc_content $my_infile_gc_content -infile_cov 40 -infile_readlen $my_infile_readlen -infile_nthreads $my_infile_nthreads -infile_erate $my_infile_erate -infile_trate $my_infile_trate -iterator ${j}
