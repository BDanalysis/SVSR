...
void simulate::germline_SNP(parameters& params)   //generate SNP variations
{
	...
	SNP_LOC1.open("./Results/snp_messaeg_1.txt",ios::out);
	if (!SNP_LOC1.is_open())
    	{
	...
	SNP_LOC2.open("./Results/snp_messaeg_2.txt",ios::out);
	if (!SNP_LOC2.is_open())
    	{
...
void simulate::somatic_SNP(parameters& params)   //generate SNP variations
{
	...
	sprintf(somatic_snp_name,"./Results/tumor%d_snp1.fa",tumor_flag);
     	...
     	sprintf(somatic_snp_name,"./Results/tumor%d_snp_message1.fa",tumor_flag);
     	SNP_LOC1.open(somatic_snp_name,ios::out);
     	sprintf(somatic_snp_name,"./Results/tumor%d_snp_message2.fa",tumor_flag);
...
int main(int   argc, char*   argv[])
{
	...
	for(int nt=0;nt<parameter1.infile_Nt;nt++)
	{
		...
		//sprintf(buffer,"rm ./Results/tumor%d_snp1.fa",tumor_flag);system(buffer);sprintf(buffer,"rm ./Results/tumor%d_snp2.fa",tumor_flag);system(buffer);
